 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_Destroy(AVCodec *codec);
 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_SetCallback(AVCodec *codec, AVCodecAsyncCallback callback, void *userData);
 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_SetSurface(AVCodec *codec, NativeWindow *window);
 ...
 * @syscap SystemCapability.Multimedia.Media.VideoDecoder
 * @param codec Pointer to an AVCodec instance
 * @param format A pointer to an AVFormat to give the description of the video track to be decoded
 * @return Returns AV_ERR_OK if the execution is successful,
 * otherwise returns a specific error code, refer to {@link AVErrCode}
 * @since 9
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_Configure(AVCodec *codec, AVFormat *format);
 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_Prepare(AVCodec *codec);
 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_Start(AVCodec *codec);
 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_Stop(AVCodec *codec);
 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_Flush(AVCodec *codec);
 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_Reset(AVCodec *codec);

/**
 * @brief Get the description information of the output data of the decoder, refer to {@link AVFormat}
 * for details. It should be noted that the life cycle of the AVFormat instance pointed to by the return
 * value will be invalid when the interface is called next time or the AVCodec instance is destroyed.
 * @syscap SystemCapability.Multimedia.Media.VideoDecoder
 * @param codec Pointer to an AVCodec instance
 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_SetParameter(AVCodec *codec, AVFormat *format);

/**
 * @brief Submit the input buffer filled with data to the video decoder. The {@link AVCodecOnNeedInputData} callback
 * will report the available input buffer and the corresponding index value. Once the buffer with the specified index
 * is submitted to the video decoder, the buffer cannot be accessed again until the {@link AVCodecOnNeedInputData}
 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_PushInputData(AVCodec *codec, uint32_t index, AVCodecBufferAttr attr);
 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_RenderOutputData(AVCodec *codec, uint32_t index);
 ...
 * @version 1.0
 */
AVErrCode OH_VideoDecoder_FreeOutputData(AVCodec *codec, uint32_t index);
