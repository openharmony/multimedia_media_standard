...
enum MediaServiceErrCode {
    ...
    MSERR_UNSUPPORT_AUD_SAMPLE_RATE,                  // unsupport sample rate.
    MSERR_UNSUPPORT_AUD_CHANNEL_NUM,                  // unsupport channel.
    ...
    MSERR_UNSUPPORT_PROTOCOL_TYPE,                    // unsupport protocl type.
    ...
    MSERR_VID_ENC_FAILED,                             // video decode failed.
    ...
    MSERR_NOT_FIND_CONTAINER,                         // not typefind a demuxer.
