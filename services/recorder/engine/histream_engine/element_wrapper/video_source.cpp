...
int32_t VideoSource::ConfigureVideoRectangle(const RecorderParam &recParam)
{
    ...
    const VidRectangle &param = (const VidRectangle&)recParam;
...
int32_t VideoSource::ConfigureVideoEncFmt(const RecorderParam &recParam)
{
    ...
    const VidEnc &param = (const VidEnc&)recParam;
...
int32_t VideoSource::ConfigureVideoBitRate(const RecorderParam &recParam)
{
    ...
    const VidBitRate &param = (const VidBitRate&)recParam;
    if (param.bitRate <= 0) {
...
int32_t VideoSource::ConfigureVideoFrameRate(const RecorderParam &recParam)
{
    ...
    const VidFrameRate &param = (const VidFrameRate&)recParam;
...
int32_t VideoSource::SetParameter(const RecorderParam &recParam)
{
    (void)recParam;
    return ERR_OK;
}
