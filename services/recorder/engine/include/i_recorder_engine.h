...
public:
    ...
    enum ErrorType : int32_t {
        ...
        ERROR_READ_DATA_ERROR,
        ERROR_INTERNAL_OPERATION_FAIL,
        ERROR_UNKNOWN,

        RECORDER_ENGINE_ERROR_TYPE_MAX,
    };
...
#endif
/**
 * Provides the factory to create RecorderEngine instance.
 */
