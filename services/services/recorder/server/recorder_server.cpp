...
int32_t RecorderServer::SetVideoSource(VideoSourceType source, int32_t &sourceId)
{
    ...
    CHECK_STATUS_FAILED_AND_LOGE_RET(status_ != REC_INITIALIZED, ERR_INVALID_OPERATION);
...
{
    std::lock_guard<std::mutex> lock(mutex_);
    CHECK_STATUS_FAILED_AND_LOGE_RET(status_ != REC_CONFIGURED, ERR_INVALID_OPERATION);
    CHECK_AND_RETURN_RET_LOG(recorderEngine_ != nullptr, ERR_INVALID_OPERATION, "engine is nullptr");
...
{
    std::lock_guard<std::mutex> lock(mutex_);
    CHECK_STATUS_FAILED_AND_LOGE_RET(status_ != REC_INITIALIZED && status_ != REC_CONFIGURED, ERR_INVALID_OPERATION);
...
int32_t RecorderServer::Start()
{
    ...
    CHECK_STATUS_FAILED_AND_LOGE_RET(status_ != REC_PREPARED, ERR_INVALID_OPERATION);
    CHECK_AND_RETURN_RET_LOG(recorderEngine_ != nullptr, ERR_INVALID_OPERATION, "engine is nullptr");
...
int32_t RecorderServer::Pause()
{
    ...
    CHECK_STATUS_FAILED_AND_LOGE_RET(status_ != REC_RECORDING, ERR_INVALID_OPERATION);
    CHECK_AND_RETURN_RET_LOG(recorderEngine_ != nullptr, ERR_INVALID_OPERATION, "engine is nullptr");
...
{
    std::lock_guard<std::mutex> lock(mutex_);
    CHECK_STATUS_FAILED_AND_LOGE_RET(status_ != REC_RECORDING && status_ != REC_PAUSED, ERR_INVALID_OPERATION);
    CHECK_AND_RETURN_RET_LOG(recorderEngine_ != nullptr, ERR_INVALID_OPERATION, "engine is nullptr");
