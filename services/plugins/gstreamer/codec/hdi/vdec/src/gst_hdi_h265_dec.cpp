...
G_DEFINE_TYPE_WITH_CODE (GstHDIH265Dec, gst_hdi_h265_dec,
    GST_TYPE_HDI_VIDEO_DEC, DEBUG_INIT);

static void
gst_hdi_h265_dec_class_init (GstHDIH265DecClass * klass)
{
  ...
  gst_hdi_class_data_init (
      &videodec_class->cdata, MEDIA_MIMETYPE_VIDEO_HEVC, VIDEO_DECODER, 0, "codec.hevc.software.decoder");
...
static void
gst_hdi_h265_dec_init (GstHDIH265Dec * self)
{
}