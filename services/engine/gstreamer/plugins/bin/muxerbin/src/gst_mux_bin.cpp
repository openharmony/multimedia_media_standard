...
static void gst_mux_bin_free_list(GSList *list)
{
    ...
    while (iter != nullptr && iter->data != nullptr) {
        if (((GstTrackInfo *)(iter->data))->srcName_ != nullptr) {
        ...
        if (((GstTrackInfo *)(iter->data))->src_ != nullptr) {
...
static bool gst_mux_bin_create_src(GstMuxBin *mux_bin, OHOS::Media::MediaType track_type)
{
    ...
    while (iter != nullptr) {
        GstElement *appSrc = GST_ELEMENT(gst_object_ref_sink(gst_element_factory_make(
            "appsrc", ((GstTrackInfo *)(iter->data))->srcName_)));
...
static bool gst_mux_bin_connect_element(GstMuxBin *mux_bin, OHOS::Media::MediaType type)
{
    ...
    while (iter != nullptr) {
        ...
        if (((GstTrackInfo *)(iter->data))->parse_ != nullptr) {
            if (!gst_mux_bin_connect_parse(mux_bin, ((GstTrackInfo *)(iter->data))->parse_,
