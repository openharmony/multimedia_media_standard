...
int32_t PlayerImpl::Seek(uint64_t mSeconds, int32_t mode)
{
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, ERR_INVALID_OPERATION, "player service does not exist..");
...
int32_t PlayerImpl::GetCurrentTime(uint64_t &currentTime)
{
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, ERR_INVALID_OPERATION, "player service does not exist..");
...
int32_t PlayerImpl::SetPlaybackSpeed(int32_t mode)
{
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, ERR_INVALID_OPERATION, "player service does not exist..");
...
int32_t PlayerImpl::GetPlaybackSpeed(int32_t &mode)
{
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, ERR_INVALID_OPERATION, "player service does not exist..");
...
int32_t PlayerImpl::GetDuration(uint64_t &duration)
{
    CHECK_AND_RETURN_RET_LOG(playerService_ != nullptr, ERR_INVALID_OPERATION, "player service does not exist..");
