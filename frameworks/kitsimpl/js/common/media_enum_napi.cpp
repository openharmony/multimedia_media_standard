...
static const std::vector<struct JsEnumInt> g_recorderAudioEncoder = {
    ...
    { "AMR_NB", 1 }, // Provide implementation only
    { "AMR_WB", 2 }, // Provide implementation only
    { "AAC_LC", AudioCodecFormat::AAC_LC },
    { "HE_AAC", 4 }, // Provide implementation only
};
...
static const std::vector<struct JsEnumInt> g_recorderAudioOutputFormat = {
    ...
    { "AMR_NB", 3 }, // Provide implementation only
    { "AMR_WB", 4 }, // Provide implementation only
